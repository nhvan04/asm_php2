                    ...
                    <div class="search_inner">
                        <form action="#">
                            ...
                            <button type="submit"> <img
                                    src="{{ asset('assets/admin/img/icon/icon_search.svg') }}" alt> </button>
                        </form>
                    </div>
                                ...
                                <div class="Notification_body">
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img
                                                    src="{{ asset('assets/admin/img/staf/2.png') }}" alt></a>
                                        </div>
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img
                                                    src="{{ asset('assets/admin/img/staf/4.png') }}" alt></a>
                                        </div>
                                        <div class="notify_content">
                                            <a href="#">
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img
                                                    src="{{ asset('assets/admin/img/staf/3.png') }}" alt></a>
                                        </div>
                                        <div class="notify_content">
                                            <a href="#">
